...
public class QuickSortTest {
    ...
    private <T extends Comparable<T>> void checkIsSorted(T[] array) {
    ...
    static class QuickSortTestTemplate implements TestTemplateInvocationContextProvider {
        ...
        private List<QuickSort> generateQuickSortMethods() {
            ...
            var combinations =
                    Sets.cartesianProduct(booleanSet, booleanSet, booleanSet, booleanSet);

            var quickSortMethods = combinations.stream()
                    .map(variant -> new QuickSort(variant.get(0) ? 15 : -1, variant.get(1), variant.get(2), variant.get(3)));
